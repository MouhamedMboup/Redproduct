  ...
  return (
    <><LoginFormContainer>
      ...
      <LoginForm>
        ...
        <form>
          <Sentence>Mot de passe oublié?</Sentence>
          <Phrase>Entrez votre adresse e-mail ci-dessous et nous vous envoyons des instructions sur la façon de modifier votre mot de passe.</Phrase>
          <LoginFormInput type="text" placeholder="Votre E-mail"></LoginFormInput><br />
          <Button type="button">Envoyez</Button>
          
        </form>
      </LoginForm>
    </LoginFormContainer>
    <Pasdecompte>Revenir a la connexion&nbsp; 
